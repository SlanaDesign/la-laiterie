...
<?php
         ...
         echo '<div>';
         echo '<h2><img src="/la-laiterie/wp-content/themes/La Laiterie/img/onde.png"> '.get_the_title($artiste->ID).'</h2>';
    ...
    <section class="aimer_aussi">
      <h2>SUGGESTION DU MOMENT <img src="/la-laiterie/wp-content/themes/La Laiterie/img/onde.png"></h2>
      <?php
